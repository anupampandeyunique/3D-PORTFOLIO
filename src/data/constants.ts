...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "LetsUpgrade",
    description: [
      "Promoted tech learning programs to fellow students.",
      "Participated in coding events and workshops.",
      "Helped students discover upskilling opportunities in tech.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.REACT,
  ...
  },
  {
    ...
    company: "United College of Engineering and Research (AKTU)",
    description: [
      "Studying core CS subjects: DSA, OS, COA, TOC, Java.",
      "Building real-world projects in Web Dev and AI.",
      "Actively learning and applying new tech skills.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.REACT,
